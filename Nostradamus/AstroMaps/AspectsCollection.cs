...
namespace Nostradamus.AstroMaps
{
    ...
    public class AspectData
    {
        ...
        public AspectData(decimal angle, string name, string acr, Pen pen)
        {
            Angle = angle;
            Name = name;
            Acronym = acr;
    ...
    public class AspectsCollection 
    {
        ...
        protected void CreateAspectsMap()
        {
           ...
           _AspectsDataCollection.Add( new AspectData((int)value, "Conjunction", "con", null));

            value = AspectType.AT_SEMISEXTILE;
            Pen pen = new Pen(Color.FromArgb(232, 102, 79), 1.5F);
            pen.DashStyle= DashStyle.Dash;
            _AspectsDataCollection.Add( new AspectData((int)value, "Semi-sextile", "ssxt", pen));

            value = AspectType.AT_SEXTILE;
            pen = new Pen(Color.FromArgb(38, 34, 213), 1.5F);
            _AspectsDataCollection.Add( new AspectData((int)value, "Sextile", "sxt", pen));

            value = AspectType.AT_QUADRO;
            pen = new Pen(Color.FromArgb(255, 40, 40), 1.5F);
            _AspectsDataCollection.Add( new AspectData((int)value, "Quadro", "qdr", pen));

            value = AspectType.AT_TRINE;
            pen = new Pen(Color.FromArgb(0, 0, 255), 1.5F);
            _AspectsDataCollection.Add( new AspectData((int)value, "Trin", "trn", pen));

            value = AspectType.AT_QUINCUNX;
            pen = new Pen(Color.FromArgb(187,49, 206), 1.5F);
            pen.DashStyle = DashStyle.Dash;
            _AspectsDataCollection.Add( new AspectData((int)value, "Quincunx", "qcx", pen));

            value = AspectType.AT_OPPOSITION;
            pen = new Pen(Color.FromArgb(208, 34, 51), 1.5F);
            _AspectsDataCollection.Add( new AspectData((int)value, "Opposition", "opp", pen));
            ...
            _AspectsDataCollection.Add( new AspectData((int)value, "Quintile", "qtl", pen));
            //144
            value = AspectType.AT_BIQUINTILE;
            pen = new Pen(Color.FromArgb(95, 140, 62), 1.5F);
            pen.DashStyle = DashStyle.DashDot;
            _AspectsDataCollection.Add( new AspectData((int)value, "Biquintile", "qtl", pen));
            //45
            value = AspectType.AT_OCTILE;
            pen = new Pen(Color.FromArgb(189, 132, 53), 1.5F);
            pen.DashStyle = DashStyle.DashDotDot;
            _AspectsDataCollection.Add( new AspectData((int)value, "Octile", "oct", pen));
            //135
            value = AspectType.AT_TRIOCTILE;
            pen = new Pen(Color.FromArgb(151, 105, 43), 1.5F);
            pen.DashStyle = DashStyle.DashDotDot;
            _AspectsDataCollection.Add( new AspectData((int)value, "Trioctile", "tct", pen));
            //36
            value = AspectType.AT_DECILE;
            pen = new Pen(Color.FromArgb(181, 84, 245), 1.5F);
            pen.DashStyle = DashStyle.DashDotDot;
            _AspectsDataCollection.Add( new AspectData((int)value, "Decile", "dcl", pen));
            //108
            value = AspectType.AT_TRIDECILE;
            pen = new Pen(Color.FromArgb(149, 13, 240), 1.5F);
            pen.DashStyle = DashStyle.DashDotDot;
            _AspectsDataCollection.Add( new AspectData((int)value, "Tridecile", "tdc", pen));
        ...
        protected AspectType GetAspectType(double angle, tPlanetType pt1, tPlanetType pt2)
        {
            ...
            //{
            //    at = GetAspectDataByvalue(36, angle, out remainder);
            //    o1 = _orbs.GetOrb(pt1, at);
            //    o2 = _orbs.GetOrb(pt2, at);
            //    o = Math.Max(o1, o2);
            //    if (o >= remainder)
            //    {
            //        at = GetAspectDataByvalue(45, angle, out remainder);
            //        o1 = _orbs.GetOrb(pt1, at);
            //        o2 = _orbs.GetOrb(pt2, at);
            //        o = Math.Max(o1, o2);
            //        if (o >= remainder)
